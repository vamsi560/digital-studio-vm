        ...
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 text-gray-300">
                ...
                <div className="flex items-center justify-between w-full">
                    <div className="flex items-center space-x-3">
                        <button 
                            ...
                            className="group bg-gradient-to-r from-gray-700 to-gray-600 hover:from-gray-600 hover:to-gray-500 text-gray-200 px-2 py-1.5 rounded-md transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 border border-gray-600/30 focus:outline-none focus:ring-2 focus:ring-green-400/50"
                        ...
                        <div className="space-y-0">
                            <h1 className="text-lg font-bold bg-gradient-to-r from-gray-200 to-gray-400 bg-clip-text text-transparent">Android Studio</h1>
                        </div>
                    </div>
            ...
            <div className="flex h-[calc(100vh-64px)] w-full px-3">
                ...
                <div className="w-48 bg-gradient-to-b from-gray-900 to-gray-800 border-r border-gray-700/50 p-2">
                    <div className="bg-gradient-to-br from-gray-800 to-gray-700 border border-gray-600/50 rounded-md p-2 h-full shadow-2xl backdrop-blur-sm">
                        <div className="flex items-center space-x-1.5 mb-3">
                            <div className="w-1 h-1 bg-green-400 rounded-full animate-pulse"></div>
                            <h3 className="text-xs font-bold text-gray-200">Import / Upload Screens</h3>
                        </div>
                        <div className="space-y-1 mb-2">
                            ...
                            <div className="mt-2">
                                <label className={`flex items-center justify-center w-full p-1.5 border-2 border-dashed rounded-sm transition-all duration-300 cursor-pointer transform hover:-translate-y-0.5 focus-within:ring-2 focus-within:ring-green-400/50 ${
                                    isDragging 
                ...
                <div className="flex-1 p-2">
                    <div className="bg-gradient-to-br from-gray-800 to-gray-700 border border-gray-600/50 rounded-md p-2 h-[calc(100vh-100px)] shadow-2xl backdrop-blur-sm relative w-full max-w-4xl mx-auto">
                        <div className="flex items-center space-x-1.5 mb-3">
                            <div className="w-1 h-1 bg-green-400 rounded-full animate-pulse"></div>
                            <h3 className="text-xs font-bold text-gray-200">Android Screen Flow Preview</h3>
                        </div>
